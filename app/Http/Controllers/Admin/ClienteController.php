   ...
   public function store(Request $request)
{
    $validator = Validator::make($request->all(), [
        ...
        'numero_documento' => 'required|string|digits:8|unique:clientes,numero_documento',
    ...
    public function update(Request $request, string $id)
{
    $validator = Validator::make($request->all(), [
        'tipo_documento' => 'required|string|in:DNI,CE|max:20',
        'numero_documento' => 'required|string|digits:8|unique:clientes,numero_documento,' . $id,
        'nombres' => 'required|string|max:100',
        'apellidos' => 'required|string|max:100',
        'telefono' => 'nullable|string|max:20',
        'direccion' => 'nullable|string|max:255',
...
{
    $clientes = Cliente::all()->sortBy('apellidos');
    $pdf = Pdf::loadView('admin.cliente.pdf', compact('clientes')); // ← ✅ CORRECTO
